...
public class TwitterClient extends OAuthBaseClient {
	...
	// publishes tweet to users timeline
	...
	// publishes tweet to users timeline
	public void getMyUser(JsonHttpResponseHandler handler) {
	...
	// publishes tweet to users timeline
	public void addFavorite(String tweetID, JsonHttpResponseHandler handler) {
	...
	// publishes tweet to users timeline
	public void deleteFavorite(String tweetID, JsonHttpResponseHandler handler) {
